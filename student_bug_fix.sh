...
html.light-theme body {
  ...
  background-image:
    radial-gradient(ellipse at 15% 15%, rgba(77,159,255,0.18) 0%, transparent 55%),
    radial-gradient(ellipse at 85% 85%, rgba(168,85,247,0.10) 0%, transparent 50%),
    radial-gradient(ellipse at 50% 0%, rgba(255,255,255,0.6) 0%, transparent 60%),
    linear-gradient(160deg, #EEF4FF 0%, #E4EEFF 40%, #F0F7FF 100%);
  color: #0D1B2E !important;
  min-height: 100vh;
}

/* Light theme text overrides — ensure visibility */
...
body.light-theme .stat-card {
  ...
  box-shadow: 0 2px 16px rgba(0,40,100,0.10) !important;
}

/* ═══════════════════════════════════════════════════════════════
   AURORA THEME — Student Special Theme (gradient purple-blue)
   ═══════════════════════════════════════════════════════════════ */
body.aurora-theme,
...
body.light-theme .tbtn { background: rgba(255,255,255,0.7); color: #0D1B2E; border-color: rgba(77,159,255,0.4); }
...
body.light-theme .sidebar-link:hover  { background: rgba(77,159,255,0.12); }
body.light-theme .sidebar-link.active { background: rgba(77,159,255,0.15); }
...
body.light-theme .pr-table th { color: #3D5068 !important; }
body.light-theme .pr-table td { color: #0D1B2E !important; }
...
body.light-theme .badge-blue  { background: rgba(77,159,255,0.14); }
