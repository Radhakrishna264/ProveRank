            ...
            {(qUploadMethod==='manual'||qUploadMethod==='copypaste') && (
              <div>
                ...
                <div style={{marginBottom:14}}>
                  ...
                  <textarea value={manualQText} onChange={e=>setManualQText(e.target.value)} rows={8} placeholder="Paste questions here..." style={{width:'100%',padding:'10px 13px',borderRadius:9,border:`1.5px solid ${iBrd}`,background:iBg,color:tm,fontSize:12,fontFamily:'monospace',resize:'vertical',outline:'none',boxSizing:'border-box'}}/>
                </div>
                <div style={{marginBottom:14}}>
      ...
      <Card>
        ...
        <div style={{padding:'20px'}}>
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(200px,1fr))',gap:12,marginBottom:20}}>
            {[
              {icon:'📊',title:'Excel Upload',desc:'POST /api/excel/questions',color:'#00C48C',sub:'XLSX/XLS/CSV format'},
              {icon:'📄',title:'PDF Parse',desc:'POST /api/upload/pdf/questions',color:'#A855F7',sub:'Auto-extract questions'},
              {icon:'📋',title:'Copy-Paste',desc:'POST /api/upload/copypaste/questions',color:'#4D9FFF',sub:'Q&A text format'},
