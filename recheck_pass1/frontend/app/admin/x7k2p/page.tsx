        ...
        <div style={{maxWidth:940,margin:'0 auto'}}>
          <div style={{display:'flex',alignItems:'center',gap:10,flexWrap:'wrap',marginBottom:10}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{display:'flex',alignItems:'center',gap:6,marginTop:1,flexWrap:'wrap'}}><span style={{fontSize:10,color:DIM,fontFamily:'monospace'}}>ID: {batch._id?.slice(-12)}...</span><span style={{fontSize:10,color:DIM}}>· {batch.createdAt?new Date(batch.createdAt).toLocaleDateString():'-'}</span></div>
            </div>
            ...
            {students.slice(0,5).map(s=>(
              <div key={s._id} className="bdr2" style={{display:'flex',alignItems:'center',gap:10,padding:'8px 6px',borderRadius:8,transition:'all 0.15s'}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  ...
                  {s.studentId&&<div style={{display:'flex',alignItems:'center',gap:3}}><span style={{fontSize:9,color:'#4D9FFF',fontFamily:'monospace'}}>{s.studentId}</span></div>}
                </div>
                ...
                <table style={{width:'100%',borderCollapse:'collapse',fontSize:12}}>
                  ...
                  <tbody>{filtered.map((s,i)=>(
                    <tr key={s._id} className="bdr2" style={{borderBottom:'1px solid '+BOR,transition:'all 0.15s'}}>
                      ...
                      <td style={{padding:'9px 8px'}}><div style={{display:'flex',alignItems:'center',gap:4}}><span style={{fontSize:11,color:'#4D9FFF',fontFamily:'monospace',fontWeight:700}}>{s.studentId||'—'}</span></div></td>
