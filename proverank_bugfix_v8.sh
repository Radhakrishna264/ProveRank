            ...
            <div style={{display:qUploadMethod==='pdf'?'block':'none'}}>
              <div>
                ...
                <div style={{marginBottom:14}}>
                  ...
                  <textarea ref={answerKeyRef} key="answerKey2" rows={4} placeholder="1-B, 2-A, 3-D ..." style={{width:'100%',padding:'10px 13px',borderRadius:9,border:`1.5px solid ${iBrd}`,background:iBg,color:tm,fontSize:12,fontFamily:'monospace',resize:'none',outline:'none',boxSizing:'border-box'}}/>
                </div>
              </div>
            )}
              </div>
