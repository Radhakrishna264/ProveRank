...
# ════════════════════════════════════════════════════════════
# CONTENT CHECKS — Key code present in files?
# ════════════════════════════════════════════════════════════
echo "🔍 Content Checks"
echo "--------------------------------------"
...
# ════════════════════════════════════════════════════════════
# URL TESTS (frontend running olni chahiye)
# ════════════════════════════════════════════════════════════
...
# Phase 7.5 URLs
check_url "$BASE_URL/admin"                      "Phase 7.5 — Admin Dashboard"
...
if [ $FAIL -eq 0 ]; then
  ...
  echo "⚠️ Some tests failed — script dobara chalao"
fi
