...
export default function AdminPanel() {
        ...
        <Card style={{maxWidth:620}}>
          ...
          <div style={{padding:'24px'}}>
            ...
            <div style={{marginBottom:14}}>
              ...
              <select defaultValue={newExamCat} onChange={e=>setNewExamCat(e.target.value)} style={{width:'100%',padding:'10px 13px',borderRadius:9,border:`1.5px solid ${iBrd}`,background:iBg,color:tm,fontSize:13,fontFamily:'Inter,sans-serif',outline:'none'}}>
    ...
    <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))',gap:14}}>
      <Card>
        ...
        <div style={{padding:'20px'}}>
          ...
          <Inp label="Ban Reason" defaultValue={banReason} onChange={setBanReason} placeholder="Enter reason..."/>
          <div style={{marginBottom:14}}>
  ...
  const renderBranding = ()=>(
    <Card style={{maxWidth:600}}>
      ...
      <div style={{padding:'24px'}}>
        <Inp label="Platform Name" defaultValue={brandName} onChange={setBrandName}/>
        <Inp label="Tagline" defaultValue={brandTagline} onChange={setBrandTagline}/>
        <Inp label="Support Email" defaultValue={brandSupport} onChange={setBrandSupport}/>
  ...
  const renderSmartGen = ()=>(
    <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))',gap:14}}>
      <Card>
        ...
        <div style={{padding:'20px'}}>
          <Inp label="Topic / Chapter" defaultValue={aiTopic} onChange={setAiTopic} placeholder="e.g. Cell Division, Thermodynamics"/>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12}}>
            <Inp label="Number of Questions" defaultValue={aiCount} onChange={setAiCount} type="number"/>
            <div style={{marginBottom:14}}>
