  ...
  const uploadQuestions = async()=>{
    ...
    try{
      ...
      if(qUploadMethod==='copypaste'||qUploadMethod==='manual'){
        const liveQText=manualQText;const liveAKey=answerKeyText;if(!liveQText.trim()){showToast('Paste question text first','error');setUploadingQ(false);return}
          ...
          <div style={{padding:'20px'}}>
            ...
            <div style={{display:(qUploadMethod==='manual'||qUploadMethod==='copypaste')?'block':'none'}}>
                ...
                <div style={{marginBottom:14}}>
                  ...
                  <textarea onChange={e=>setManualQText(e.target.value)} rows={8} id="manualQBox" placeholder="Paste questions here..." style={{width:'100%',padding:'10px 13px',borderRadius:9,border:`1.5px solid ${iBrd}`,background:iBg,color:tm,fontSize:12,fontFamily:'monospace',resize:'vertical',outline:'none',boxSizing:'border-box'}}/>
                </div>
                <div style={{marginBottom:14}}>
                  ...
                  <textarea onChange={e=>setAnswerKeyText(e.target.value)} rows={4} placeholder="1-B 2-A 3-D" style={{width:'100%',padding:'10px 13px',borderRadius:9,border:`1.5px solid ${iBrd}`,background:iBg,color:tm,fontSize:12,fontFamily:'monospace',resize:'none',outline:'none',boxSizing:'border-box'}}/>
                </div>
            </div>
