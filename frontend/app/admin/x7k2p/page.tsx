                            ...
                            <div style={{display:'flex',alignItems:'flex-start',gap:7}}>
                              ...
                              <div style={{flex:1,minWidth:0}}>
                                <div style={{display:'flex',gap:4,marginBottom:4,flexWrap:'wrap',alignItems:'center'}}>
                                  <span style={{fontSize:13,color:'#fff',fontWeight:800,background:'linear-gradient(135deg,#4D9FFF,#a78bfa)',borderRadius:6,padding:'3px 10px',minWidth:30,textAlign:'center',display:'inline-block',flexShrink:0,boxShadow:'0 1px 4px rgba(77,159,255,0.4)'}}>#{qi+1}</span>
